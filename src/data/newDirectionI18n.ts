  ...
  pl: {
    ...
    about: {
      ...
      stackMeta: 'NARZĘDZIA', stackTitle: 'Technologia jako', stackAccent: 'narzędzie.', stack: [
        { label: 'Frontend', value: 'HTML · CSS · JavaScript · TypeScript' }, { label: 'Frameworki', value: 'Astro · Next.js · Tailwind' }, { label: 'Animacja', value: 'GSAP · CSS motion' }, { label: 'Wdrożenie', value: 'Netlify · Vercel · GitHub Pages' },
  ...
  ru: {
    ...
    about: {
      ...
      stackMeta: 'ИНСТРУМЕНТЫ', stackTitle: 'Технологии — это', stackAccent: 'инструмент.', stack: [
        { label: 'Frontend', value: 'HTML · CSS · JavaScript · TypeScript' }, { label: 'Фреймворки', value: 'Astro · Next.js · Tailwind' }, { label: 'Анимация', value: 'GSAP · CSS motion' }, { label: 'Запуск', value: 'Netlify · Vercel · GitHub Pages' },
  ...
  en: {
    ...
    about: {
      ...
      stackMeta: 'TOOLS', stackTitle: 'Technology is a', stackAccent: 'tool.', stack: [
        { label: 'Frontend', value: 'HTML · CSS · JavaScript · TypeScript' }, { label: 'Frameworks', value: 'Astro · Next.js · Tailwind' }, { label: 'Motion', value: 'GSAP · CSS motion' }, { label: 'Deployment', value: 'Netlify · Vercel · GitHub Pages' },
  ...
  ua: {
    ...
    about: {
      ...
      stackMeta: 'ІНСТРУМЕНТИ', stackTitle: 'Технології — це', stackAccent: 'інструмент.', stack: [
        { label: 'Frontend', value: 'HTML · CSS · JavaScript · TypeScript' }, { label: 'Фреймворки', value: 'Astro · Next.js · Tailwind' }, { label: 'Анімація', value: 'GSAP · CSS motion' }, { label: 'Запуск', value: 'Netlify · Vercel · GitHub Pages' },
